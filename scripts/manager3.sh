...
/usr/local/bin/swarmd -d /tmp/swarmkit-stress-tester/manager3 --join-addr 10.10.10.11:4242 --join-token $TOKEN --listen-control-api /tmp/swarmkit-stress-tester/manager3.sock --listen-remote-api 10.10.30.11:4242 --advertise-remote-api 10.10.30.11:4242 --hostname manager3
