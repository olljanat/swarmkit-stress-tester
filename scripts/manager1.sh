...
/usr/local/bin/swarmd -d /tmp/swarmkit-stress-tester/manager1 --listen-control-api /tmp/swarmkit-stress-tester/manager1.sock --listen-remote-api 10.10.10.11:4242 --hostname manager1
